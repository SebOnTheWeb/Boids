...
Scene::Scene(Renderer* rendererPtr) {
	...
	this->storageBuffers[0] = new StorageBuffer(rendererPtr, NR_OF_BOIDS, sizeof(Boid)); // TODO: Don't use default constructor
	this->storageBuffers[1] = new StorageBuffer(rendererPtr, NR_OF_BOIDS, sizeof(Boid)); // TODO: Don't use default constructor
}
